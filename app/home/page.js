    ...
    return (
        <>
            <main className='max-w-[1200px] mx-auto p-5'>
                ...
                <section className='promotion-banner w-full md:h-[65vh] h-[200px] mb-10'>
                    <img className="banner-image w-full h-full object-cover" src="/fashion.jpg" alt="Big Promotion Banner" />
                </section>
                ...
                <section className="features flex justify-between max-md:items-center md:gap-5 gap-1.5 mb-10">
                    ...
                    <div className="feature max-md:mb-5 max-md:min-h-48 text-center flex flex-col md:justify-center items-center flex-1 px-4 py-1.5 bg-white rounded-lg shadow-md">
                        ...
                        <p className='text-sm text-gray-700 pb-0.5'><strong>10-15 Min. Delivery</strong></p>
                    ...
                    <div className="product-category mb-10 new-products">
                        ...
                        <div className="product-list flex overflow-x-auto gap-5 pb-2 snap-x snap-mandatory [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                            ...
                            <article className="product-card max-md:w-full bg-white p-5 rounded-lg shadow-md min-w-3xs text-center snap-start transition-transform duration-300 ease-in-out hover:scale-105">
                                <img className='w-full h-auto rounded-lg mb-2.5' src="new-product1.jpg" alt="New Product 1" />
                                <h3 className='font-bold text-xl text-gray-800'>New Product 1</h3>
                                <p className='text-gray-800 mb-5'>&#8377;100.00</p>
                            ...
                            <article className="product-card max-md:w-full bg-white p-5 rounded-lg shadow-md min-w-3xs text-center snap-start transition-transform duration-300 ease-in-out hover:scale-105">
                                <img className='w-full h-auto rounded-lg mb-2.5' src="new-product2.jpg" alt="New Product 2" />
                                <h3 className='font-bold text-xl text-gray-800'>New Product 2</h3>
                                <p className='text-gray-800 mb-5'>&#8377;110.00</p>
                                <button className='bg-[#007bff] hover:bg-[#0056b3] text-white border-none px-5 py-2.5 rounded-md cursor-pointer transition-colors duration-300'>Add to Cart</button>
                            </article>
                            <article className="product-card max-md:w-full bg-white p-5 rounded-lg shadow-md min-w-3xs text-center snap-start transition-transform duration-300 ease-in-out hover:scale-105">
                                <img className='w-full h-auto rounded-lg mb-2.5' src="new-product3.jpg" alt="New Product 3" />
                                <h3 className='font-bold text-xl text-gray-800'>New Product 3</h3>
                            ...
                            <article className="product-card max-md:w-full bg-white p-5 rounded-lg shadow-md min-w-3xs text-center snap-start transition-transform duration-300 ease-in-out hover:scale-105">
                                <img className='w-full h-auto rounded-lg mb-2.5' src="new-product3.jpg" alt="New Product 3" />
                                <h3 className='font-bold text-xl text-gray-800'>New Product 4</h3>
                                <p className='text-gray-800 mb-5'>&#8377;120.00</p>
                                <button className='bg-[#007bff] hover:bg-[#0056b3] text-white border-none px-5 py-2.5 rounded-md cursor-pointer transition-colors duration-300'>Add to Cart</button>
                            </article>
                            ...
                            <article className="product-card max-md:w-full bg-white p-5 rounded-lg shadow-md min-w-3xs text-center snap-start transition-transform duration-300 ease-in-out hover:scale-105">
                                <img className='w-full h-auto rounded-lg mb-2.5' src="new-product3.jpg" alt="New Product 3" />
                                <h3 className='font-bold text-xl text-gray-800'>New Product 5</h3>
                                <p className='text-gray-800 mb-5'>&#8377;120.00</p>
                                <button className='bg-[#007bff] hover:bg-[#0056b3] text-white border-none px-5 py-2.5 rounded-md cursor-pointer transition-colors duration-300'>Add to Cart</button>
                            </article>
                            ...
                            <article className="product-card max-md:w-full bg-white p-5 rounded-lg shadow-md min-w-3xs text-center snap-start transition-transform duration-300 ease-in-out hover:scale-105">
                                <img className='w-full h-auto rounded-lg mb-2.5' src="new-product3.jpg" alt="New Product 3" />
                                <h3 className='font-bold text-xl text-gray-800'>New Product 6</h3>
                                <p className='text-gray-800 mb-5'>&#8377;120.00</p>
                                <button className='bg-[#007bff] hover:bg-[#0056b3] text-white border-none px-5 py-2.5 rounded-md cursor-pointer transition-colors duration-300'>Add to Cart</button>
                            </article>
                            ...
                            <article className="product-card max-md:w-full bg-white p-5 rounded-lg shadow-md min-w-3xs text-center snap-start transition-transform duration-300 ease-in-out hover:scale-105">
                                <img className='w-full h-auto rounded-lg mb-2.5' src="new-product3.jpg" alt="New Product 3" />
                                <h3 className='font-bold text-xl text-gray-800'>New Product 7</h3>
                                <p className='text-gray-800 mb-5'>&#8377;120.00</p>
                                <button className='bg-[#007bff] hover:bg-[#0056b3] text-white border-none px-5 py-2.5 rounded-md cursor-pointer transition-colors duration-300'>Add to Cart</button>
                            </article>
                            ...
                            <article className="product-card max-md:w-full bg-white p-5 rounded-lg shadow-md min-w-3xs text-center snap-start transition-transform duration-300 ease-in-out hover:scale-105">
                                <img className='w-full h-auto rounded-lg mb-2.5' src="new-product3.jpg" alt="New Product 3" />
                                <h3 className='font-bold text-xl text-gray-800'>New Product 8</h3>
                                <p className='text-gray-800 mb-5'>&#8377;120.00</p>
                                <button className='bg-[#007bff] hover:bg-[#0056b3] text-white border-none px-5 py-2.5 rounded-md cursor-pointer transition-colors duration-300'>Add to Cart</button>
                            </article>
