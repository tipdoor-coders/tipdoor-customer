            ...
            <div className='footer-content flex justify-between flex-wrap mb-5'>
                ...
                <div className='footer-section flex-1 min-w-[200px] mr-5'>
                    ...
                    <ul className='list-none md:space-y-2.5 space-y-1 social-media flex gap-3.5'>
                        ...
                        <li><NavLink href='https://www.instagram.com/tipdoor?utm_source=qr&igsh=MTE1aHduZHl3YzNqeg==' target='_blank' className='instagram text-[#bbb] no-underline text-[1.2rem] transition-colors duration-300 ease-in-out hover:text-[#fff]'><FaInstagram /></NavLink></li>
