        ...
        <>
            <main className='max-w-[1200px] mx-auto p-5'>
                ...
                <section className="features flex justify-between max-md:items-center md:gap-5 gap-1.5 mb-10">
                    ...
                    {/* AI Try-On */}
                    <div className="feature max-md:min-h-48 text-center flex flex-col md:justify-center items-center flex-1 px-4 py-2 bg-white rounded-lg shadow-md mb-4 md:mb-0 transition-transform hover:-translate-y-1 hover:shadow-lg">
                    ...
                    <div className="feature max-md:min-h-48 text-center flex flex-col md:justify-center items-center flex-1 px-4 py-3 bg-white rounded-xl shadow-md transition-transform hover:-translate-y-1 hover:shadow-lg">
                        <svg
                    ...
                    {/* Fast Delivery */}
                    <div className="feature max-md:min-h-48 text-center flex flex-col md:justify-center items-center flex-1 px-4 py-1.5 bg-white rounded-lg shadow-md transition-transform hover:-translate-y-1 hover:shadow-lg">
